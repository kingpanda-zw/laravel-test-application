...
<body class="antialiased">
    ...
    <div class="bg-gradient-to-r from-purple-200 to-gray-200">
        <div class="w-9/12 m-auto py-16 min-h-screen flex items-center justify-center">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg pb-8">
                <div class="border-t border-gray-200 text-center pt-8">
                    ...
                    <h2 class="text-2xl mb-4 text-gray-800 text-center font-bold">Thanks for your order!</h2>
                    <p class="text-2xl pb-8 px-12 font-medium">We appreciate your business!
                        If you have any questions, please email orders@email.com</p>
                    <a href="{{ route('home') }}"
                        class="bg-indigo-600 border border-transparent rounded-md py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Go to Home
                    </a>
                </div>
            </div>
